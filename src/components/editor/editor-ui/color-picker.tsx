...
function ColorPickerHueSlider(props: ColorPickerHueSliderProps) {
  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="border-border-selected/50 bg-surface focus-visible:ring-border-focused block size-4 rounded-full border shadow transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50" />
    </SliderPrimitive.Root>
  );
}
